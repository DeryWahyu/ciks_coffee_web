...
<style>
    ...
    @media (min-width:640px) { .table-stat-grid { grid-template-columns:repeat(5,minmax(0,1fr)); } .table-hero { padding:1.5rem; } .table-floor-scroll { padding:1rem; } .table-modal-backdrop { align-items:center; } }
</style>
@endpush
