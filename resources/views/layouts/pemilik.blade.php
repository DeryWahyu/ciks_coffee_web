...
<body class="min-h-screen bg-cream-light font-sans antialiased">
    <div class="flex min-h-screen">
        ...
        <aside class="hidden lg:flex lg:flex-col w-64 bg-white border-r border-latte/60 fixed inset-y-0 left-0 z-30" id="sidebar">
            ...
            <nav class="flex-1 overflow-y-auto py-4">
                ...
                <div class="mt-4">
                    ...
                    <div id="dropdown-kelola" class="dropdown-menu">
                ...
                {{-- Laporan Dropdown --}}
                @php $laporanOpen = request()->routeIs('pemilik.reports.*') || request()->routeIs('pemilik.performance.*'); @endphp
                <div class="mt-1">
                    <button id="btn-laporan" onclick="toggleDropdown('laporan')" class="dropdown-toggle w-full flex items-center justify-between px-6 py-2 sidebar-section-title !py-2.5 !px-5 rounded-lg mx-1" style="width:calc(100% - 0.5rem)">
                        <span>Laporan</span>
                        <svg class="dropdown-icon w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5"/></svg>
                    </button>
                    <div id="dropdown-laporan" class="dropdown-menu">
                        ...
                        <a href="{{ route('pemilik.performance.employees') }}" class="sidebar-link flex items-center gap-3 pl-8 pr-6 py-2 text-sm {{ request()->routeIs('pemilik.performance.employees') ? 'active text-espresso font-semibold' : 'text-espresso/70 hover:text-espresso' }}">
                        ...
                        <a href="{{ route('pemilik.performance.products') }}" class="sidebar-link flex items-center gap-3 pl-8 pr-6 py-2 text-sm {{ request()->routeIs('pemilik.performance.products') ? 'active text-espresso font-semibold' : 'text-espresso/70 hover:text-espresso' }}">
                ...
                {{-- Analisis Dropdown --}}
                @php $analisisOpen = request()->routeIs('pemilik.analytics.*') || request()->routeIs('pemilik.customers.*') || request()->routeIs('pemilik.exports.*'); @endphp
                <div class="mt-1">
                    <button id="btn-analisis" onclick="toggleDropdown('analisis')" class="dropdown-toggle w-full flex items-center justify-between px-6 py-2 sidebar-section-title !py-2.5 !px-5 rounded-lg mx-1" style="width:calc(100% - 0.5rem)">
                        <span>Analisis</span>
                        <svg class="dropdown-icon w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5"/></svg>
                    </button>
                    <div id="dropdown-analisis" class="dropdown-menu">
                        ...
                        <a href="{{ route('pemilik.customers.index') }}" class="sidebar-link flex items-center gap-3 pl-8 pr-6 py-2 text-sm {{ request()->routeIs('pemilik.customers.*') ? 'active text-espresso font-semibold' : 'text-espresso/70 hover:text-espresso' }}">
                            <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z"/></svg>
                            Pelanggan
                        </a>
        ...
        <div class="lg:hidden fixed top-0 inset-x-0 z-30 bg-espresso shadow-lg">
            ...
            <div id="mobile-menu" class="hidden bg-espresso-light border-t border-espresso/30 pb-3">
                ...
                <a href="{{ route('pemilik.performance.employees') }}" class="block px-4 py-2.5 text-sm {{ request()->routeIs('pemilik.performance.employees') ? 'text-cream font-semibold' : 'text-cream/70' }}">Performa Karyawan</a>
                <a href="{{ route('pemilik.performance.products') }}" class="block px-4 py-2.5 text-sm {{ request()->routeIs('pemilik.performance.products') ? 'text-cream font-semibold' : 'text-cream/70' }}">Performa Produk</a>
    ...
    <script>
        ...
        function toggleDropdown(name) {
            ...
            const btn = document.getElementById('btn-' + name) || menu.previousElementSibling;
