...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-latte/50 p-5">
            <p class="text-[0.65rem] text-caramel font-semibold uppercase tracking-wider mb-2">Performa Terbaik</p>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-latte/50 p-6">
        <h4 class="text-sm font-bold text-espresso mb-5 flex items-center gap-2">
            ...
            Papan Peringkat — {{ \Carbon\Carbon::parse($startDate)->translatedFormat('d M Y') }} s/d {{ \Carbon\Carbon::parse($endDate)->translatedFormat('d M Y') }}
        </h4>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-caramel-dark">
                                    ...
                                    <span>Rata-rata Rp {{ number_format($emp->avg_order_value, 0, ',', '.') }}</span>
